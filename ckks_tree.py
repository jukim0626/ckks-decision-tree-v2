...
# 아래는 archive/main.py(구 sklearn 파이프라인)와 함께 쓰이던 코드다. 지금 client_assisted
# 패키지는 encrypted_depth2_inference.py에서 client가 직접 decrypt+plaintext argmax를 하므로
# (논문 Section 4.1 방식, EXPERIMENT_LOG 2026-07-06 "encrypted_argmax 제거" 참고) 이 코드는
# 안 쓴다. 나중에 "raw class score를 아예 안 드러내는" 더 강한 privacy가 필요해지면 참고할 것.
#
# from sigmoid_approx_coeffs import COMPARE_SIGMOID_COEFFS, SIGMOID_APPROX_DEGREE
# import numpy as np
#
...
#
#     max_level=25: 15차 sigmoid polynomial 기준 tree traversal과 argmax 여유분 포함.
...
#         return sigmoid_approx_enc(engine, rlk, scaled, COMPARE_SIGMOID_COEFFS)
#
