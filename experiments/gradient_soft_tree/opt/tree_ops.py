...
from closed_form_mgi.soft_mgi import _extract_weight_broadcast
from experiments.gradient_soft_tree.depth1_ckks import softmax_exp_coeffs, _EXP_MAX
from experiments.gradient_soft_tree.opt.config import TreeConfig
from experiments.gradient_soft_tree.opt.poly_gate import (
    gate_coeffs,
    gate_derivative_coeffs,
    gate_entry_min_level,
)
from experiments.gradient_soft_tree.opt.profiler import batch_ensure_level_profiled, ensure_level_profiled
