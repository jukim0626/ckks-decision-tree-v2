...
from models.gradient_soft_tree.depth1_reference import softmax, softmax_backward
    ...
    for level in reversed(range(depth)):
        ...
        for idx in range(count):
            ...
            if config.attention_softmax:
                ...
                from models.gradient_soft_tree.opt.reference_variants import _regularizer_grad
